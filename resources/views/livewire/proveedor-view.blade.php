            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($proveedores as $proveedor)
                        <tr>
                            <td class="px-6 py-4 break-words">{{ $proveedor->nombre }}</td>
                            <td class="px-6 py-4 break-words">{{ $proveedor->telefono }}</td>
                            <td class="px-6 py-4 break-words">{{ $proveedor->direccion }}</td>
                            <td class="px-6 py-4 break-words">{{ $proveedor->ciudad }}</td>
                            <td class="px-6 py-4 break-words">{{ $proveedor->pais }}</td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <button wire:click="openVerModal({{ $proveedor }})"
                                    class=" p-2 bg-red-500 text-white rounded-md ">
                                    Ver
                                </button> | <button wire:click="openModal({{ $proveedor }})"
                                    class=" p-2 bg-red-500 text-white rounded-md ">
                                    Editar
                                </button>
                            </td>
                        ...
                        <div class="m-8 my-20 max-w-[400px] mx-auto">
                            <div class="mb-8">
                                ...
                                <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                                    {{ isset($miProveedor->id) ? 'Actualizar' : 'Crear' }} Proveedor
                                </h3>

                                <form wire:submit.prevent="guardarOActualizar" class="space-y-4">
                                    <div>
                                        <label for="nombre"
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="pais" wire:model.defer="pais"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                        @error('pais')
                                            <span class="text-red-500 text-xs">{{ $message }}</span>
                                        @enderror
                    ...
                    <div class="w-full">
                        ...
                        <div class="m-8 my-20 max-w-[400px] mx-auto">
                            <div class="mb-8">
                                ...
                                <form wire:submit.prevent="" class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input disabled type="text" id="telefono" wire:model.defer="telefono"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                        @error('telefono')
                                            <span class="text-red-500 text-xs">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div>
                                        <label for="direccion"
                                            class="block text-sm font-medium text-gray-700">Direccion</label>
                                        <input disabled type="text" id="direccion" wire:model.defer="direccion"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                        @error('direccion')
                                            <span class="text-red-500 text-xs">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div>
                                        <label for="ciudad"
                                            class="block text-sm font-medium text-gray-700">Ciudad</label>
                                        <input disabled type="text" id="ciudad" wire:model.defer="ciudad"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                        @error('ciudad')
                                            <span class="text-red-500 text-xs">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div>
                                        <label for="pais"
                                            class="block text-sm font-medium text-gray-700">Pais</label>
                                        <input disabled type="email" id="pais" wire:model.defer="pais"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                        @error('pais')
                                            <span class="text-red-500 text-xs">{{ $message }}</span>
                                        @enderror
                            ...
                            <div class="flex flex-row">
                                ...
                                <button wire:click.prevent="closeVerModal"
                                    class="p-3 bg-white border rounded-full w-full font-semibold">
                                    Cancelar
                                </button>
                            </div>
